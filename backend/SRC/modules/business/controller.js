...
export class BusinessController {
  ...
  create = async (req, res, next) => {
    try {
      ...
      res
        .status(201)
        .json(successResponse("Business created successfully", business));
    } catch (error) {
      next(error);
    }
  };
  ...
  list = async (req, res, next) => {
    try {
      ...
      res
        .status(200)
        .json(successResponse("Businesses fetched successfully", businesses));
    } catch (error) {
      next(error);
    }
  };
  ...
  upgrade = async (req, res, next) => {
    try {
      ...
      res
        .status(200)
        .json(successResponse("Business upgraded successfully", business));
    } catch (error) {
      next(error);
    }
  };
  ...
  collect = async (req, res, next) => {
    try {
      ...
      res
        ...
        .json(
          successResponse(
            `Accrued profit of $${result.collectedAmount} collected`,
            result,
          ),
        );
    } catch (error) {
